    ...
    getActive: publicProcedure.query(async () => {
      ...
      const rows = await dbInstance
        .select({
          ...
          ctaSecondaryLabel: sponsoredSpotlights.ctaSecondaryLabel,
          ctaSecondaryLabelEn: sponsoredSpotlights.ctaSecondaryLabelEn,
          ctaSecondaryHref: sponsoredSpotlights.ctaSecondaryHref,
    ...
    create: adminProcedure
      .input(
        z.object({
          ...
          ctaSecondaryLabelEn: z.string().trim().max(60).optional().nullable(),
          ctaSecondaryHref: z.string().trim().max(500).optional().nullable(),
