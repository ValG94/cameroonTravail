      ...
      <div className="max-w-md mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="mt-6">
            ...
            <button
              type="button"
              className="mt-4 w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
            >
